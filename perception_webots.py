# perception_webots.py — Analyse du tableau lidar avec config Webots
# Identique à perception.py mais importe config_webots au lieu de config
...
if __name__ == "__main__":
    ...
    infos = analyser(tab)
    print("=== Test perception_webots.py ===")
